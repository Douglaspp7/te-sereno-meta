// Kill-switch service worker: evicts old Workbox PWA, unregisters self.
function isWorkboxCacheForThisRegistration(name) {
  const hasWorkboxBucket = /(^|-)precache-v\d+-|(^|-)runtime-|(^|-)googleAnalytics-|^html-navigations$|^static-assets$/.test(name);
