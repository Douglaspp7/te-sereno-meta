...
const REWARDS = [
  { id: 1, name: "10 Recetas Express", condition: "7 días consecutivos", icon: Utensils, type: "streak", target: 7, unlockMsg: "Mantén tu racha 7 días para desbloquear 10 Recetas Express." },
  { id: 2, name: "Postres Saludables", condition: "14 días consecutivos", icon: Flame, type: "streak", target: 14, unlockMsg: "Mantén tu racha 14 días para desbloquear Postres Saludables." },
  { id: 3, name: "Guía de Compras Inteligentes", condition: "10 comidas preparadas", icon: ShoppingCart, type: "meals", target: 10, unlockMsg: "Prepara 10 comidas para desbloquear Guía de Compras." },
  { id: 4, name: "Menú de Emergencia", condition: "5 ejercicios realizados", icon: Dumbbell, type: "exercises", target: 5, unlockMsg: "Realiza 5 ejercicios para desbloquear Menú de Emergencia." },
  { id: 5, name: "21 Recetas Premium Extra", condition: "50% del desafío", icon: Sparkles, type: "plan", target: 50, unlockMsg: "Alcanza 50% del plan para desbloquear 21 Recetas Premium." },
